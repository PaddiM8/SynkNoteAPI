...
namespace SynkNote.Algorithms
{
    public class PBKDF2
    {
        public static string Hash(string password)
        {
            ...
            byte[] hash = Pbkdf2(password, salt, Config.HashIterations, 20);
            return Config.HashIterations + ":" + Convert.ToBase64String(salt) + ":" + Convert.ToBase64String(hash);
        }
